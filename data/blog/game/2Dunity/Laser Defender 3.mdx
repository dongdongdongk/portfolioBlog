---
title: '섹션 6: Laser Defender 3'
date: '2025-09-08'
category: 'Developer/Unity/2D 게임 개발'
tags:
  ['Unity', 'C#', '2D 게임', '오디오 시스템', '점수 시스템', 'UI 설계', '씬 관리', '싱글턴 패턴']
draft: false
summary: 'Unity에서 오디오 효과와 배경 음악 추가, 점수 및 에너지 시스템 구현, UI 설계, 씬 전환 및 싱글턴 패턴을 활용한 게임 완성도 향상 가이드입니다.'
---
...
1. [Unity 게임에 오디오 추가](#unity-게임에-오디오-추가)
2. [배경 음악 시스템](#배경-음악-시스템)
3. [점수 시스템 구현](#점수-시스템-구현)
4. [에너지 시스템](#에너지-시스템)
5. [UI 설계](#ui-설계)
6. [씬 관리 시스템](#씬-관리-시스템)
7. [싱글턴 패턴 활용](#싱글턴-패턴-활용)
8. [게임 완성](#게임-완성)
...
<Image src="/images/blog/game/image 521.webp" alt="Unity 게임 스크린샷" width={800} height={450} />
...
<Image src="/images/blog/game/image 522.webp" alt="Unity 게임 스크린샷" width={800} height={450} />

<Image src="/images/blog/game/image 523.webp" alt="Unity 게임 스크린샷" width={800} height={450} />

<Image src="/images/blog/game/image 524.webp" alt="Unity 게임 스크린샷" width={800} height={450} />

<Image src="/images/blog/game/image 525.webp" alt="Unity 게임 스크린샷" width={800} height={450} />

```csharp
패널 추가
```

<Image src="/images/blog/game/image 526.webp" alt="Unity 게임 스크린샷" width={800} height={450} />

```csharp
엥커 조절
```

<Image src="/images/blog/game/image 527.webp" alt="Unity 게임 스크린샷" width={800} height={450} />

```csharp
슬라이드 바 앵커를 조절 ( 앵커는 x 표시로 4개가 분할된 형태 )
```

<Image src="/images/blog/game/image 528.webp" alt="Unity 게임 스크린샷" width={800} height={450} />

<Image src="/images/blog/game/image 529.webp" alt="Unity 게임 스크린샷" width={800} height={450} />

```csharp
텍스트 앵커 설정과 25 정도의 패팅 그리고 글자 크기 auto
```

<Image src="/images/blog/game/image 530.webp" alt="Unity 게임 스크린샷" width={800} height={450} />

```csharp
폰트 추가
```

<Image src="/images/blog/game/image 531.webp" alt="Unity 게임 스크린샷" width={800} height={450} />
...
<Image src="/images/blog/game/image 532.webp" alt="Unity 게임 스크린샷" width={800} height={450} />
...
<Image src="/images/blog/game/image 533.webp" alt="Unity 게임 스크린샷" width={800} height={450} />

```csharp
새로 캔버스에 추가하면 이벤트 시스템에 리플레이스 눌러주기
```

<Image src="/images/blog/game/image 534.webp" alt="Unity 게임 스크린샷" width={800} height={450} />
...
<Image src="/images/blog/game/image 535.webp" alt="Unity 게임 스크린샷" width={800} height={450} />

```csharp
빌드 셋팅에 새로 만든 씬 추가
```

<Image src="/images/blog/game/image 536.webp" alt="Unity 게임 스크린샷" width={800} height={450} />
...
<Image src="/images/blog/game/image 537.webp" alt="Unity 게임 스크린샷" width={800} height={450} />
...
<Image src="/images/blog/game/image 538.webp" alt="Unity 게임 스크린샷" width={800} height={450} />
...
<Image src="/images/blog/game/image 539.webp" alt="Unity 게임 스크린샷" width={800} height={450} />

```csharp
패딩을 수정해서 플레이어 캐릭터 이동 범위 화면의 반 정도로 제약
```

<Image src="/images/blog/game/image 540.webp" alt="Unity 게임 스크린샷" width={800} height={450} />

```csharp
빌드 셋팅
```

<Image src="/images/blog/game/image 541.webp" alt="Unity 게임 스크린샷" width={800} height={450} />
...
<Image src="/images/blog/game/image 542.webp" alt="Unity 게임 스크린샷" width={800} height={450} />

```csharp
빌드 진행 -> 빌드 완료
```

<Image src="/images/blog/game/image 543.webp" alt="Unity 게임 스크린샷" width={800} height={450} />

```csharp
WebGL 로 전환
```

<Image src="/images/blog/game/image 544.webp" alt="Unity 게임 스크린샷" width={800} height={450} />
