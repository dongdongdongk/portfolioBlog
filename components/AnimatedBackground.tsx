...
export default function AnimatedBackground({ className = '' }: AnimatedBackgroundProps) {
  ...
  useEffect(() => {
    ...
    const newParticles = Array.from({ length: 20 }, (_, i) => ({
      ...
      color: i % 4 === 0 ? 'bg-blue-500/12' : 
             i % 4 === 1 ? 'bg-primary-500/12' : 
             i % 4 === 2 ? 'bg-purple-500/12' : 'bg-cyan-500/12'
    }))
  ...
  return (
    <>
      ...
      <div className={`absolute inset-0 ${className}`}>
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-primary-500/8 via-transparent to-blue-500/8"></div>
        ...
        <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-blue-500/12 to-primary-500/8 rounded-full blur-3xl" style={{ 
          animation: 'pulse-gentle 6s ease-in-out infinite'
        }}></div>
        <div className="absolute top-20 right-0 w-80 h-80 bg-gradient-to-bl from-purple-500/10 to-pink-500/6 rounded-full blur-3xl" style={{ 
          animation: 'pulse-gentle 8s ease-in-out infinite',
          animationDelay: '3s' 
        }}></div>
        <div className="absolute bottom-0 left-1/3 w-72 h-72 bg-gradient-to-tr from-cyan-500/8 to-teal-500/6 rounded-full blur-3xl" style={{ 
