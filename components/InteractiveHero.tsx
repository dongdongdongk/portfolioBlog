...
export default function InteractiveHero({
  ...
  return (
    <div
      ref={heroRef}
      className="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gradient-to-br from-slate-950 via-gray-900 to-slate-950 py-8 sm:py-12 md:py-16"
    >
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center space-y-4 px-4 sm:space-y-6 sm:px-6 md:space-y-8 md:px-8 lg:space-y-4">
        ...
        <div
          className={`flex items-start justify-center gap-16 transition-all delay-1200 duration-1000 sm:gap-28 md:gap-36 lg:gap-48 xl:gap-56 ${
            isVisible ? 'opacity-100' : 'opacity-0'
          }`}
        >
