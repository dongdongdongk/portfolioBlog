...
tags:
  ['Unity', 'C#', '2D 게임', 'Button 이벤트', 'Timer 시스템', 'List', 'ScoreKeeper', '게임 매니저']
draft: false
summary: '버튼 상호작용, 타이머 시스템, 점수 추적, 게임 완성도를 높이는 퀴즈 게임의 고급 기능 구현 가이드입니다.'
---

# 섹션 4: 퀴즈 마스터 - 2

퀴즈 게임의 고급 기능 구현 가이드입니다. 타이머 시스템, 점수 관리, 게임 상태 제어 등을 통해 완성도 높은 퀴즈 게임을 만들어봅니다.

## 목차

1. [UI 버튼에 텍스트 표시하기](#유니티-ui-버튼에-스크립터블-오브젝트에서-가져온-텍스트를-표시하기)
2. [버튼 상호작용 구현](#버튼-상호작용-구현)
3. [타이머 시스템](#타이머-시스템)
4. [점수 관리 시스템](#점수-관리-시스템)
5. [게임 상태 제어](#게임-상태-제어)
6. [List를 활용한 데이터 관리](#list를-활용한-데이터-관리)
7. [완성된 퀴즈 게임](#완성된-퀴즈-게임)
