  ...
  return (
    <>
      <ScrollReveal className="mb-20 text-center">
        <div className="mb-8 inline-flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-400 to-cyan-500">
          <svg
        ...
        <h2 className="mb-6 bg-gradient-to-r from-blue-300 to-cyan-400 bg-clip-text text-4xl font-bold text-transparent md:text-5xl">
          Developer 김동현
        </h2>
        <p className="mx-auto max-w-4xl text-lg leading-relaxed text-gray-300 md:text-xl">
          이젠솔루션과 우리아이시티에서 근무하며 다양한 프로젝트를 수행한 자기주도 학습형
          개발자입니다. Java, Spring Framework, MERN 스택 등 다양한 기술로 문제를 해결합니다.
        </p>
      </ScrollReveal>
      ...
      <ScrollReveal delay={200} className="mb-16">
        <div className="mb-12 text-center">
          <h3 className="mb-4 text-3xl font-bold text-blue-200">핵심 기술 스택</h3>
          <p className="text-lg text-gray-400">실무에서 활용하는 다양한 기술과 도구들</p>
        </div>
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          <ScrollReveal delay={400}>
            <div className="rounded-2xl border border-blue-500/30 bg-blue-900/20 p-6 backdrop-blur-lg transition-all duration-300 hover:bg-blue-900/30">
          ...
          <ScrollReveal delay={600}>
            <div className="rounded-2xl border border-blue-500/30 bg-blue-900/20 p-6 backdrop-blur-lg transition-all duration-300 hover:bg-blue-900/30">
              ...
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-center">
                  <span className="mr-3 h-2 w-2 rounded-full bg-cyan-500"></span>
                  React & Next.js
                </li>
                <li className="flex items-center">
                  <span className="mr-3 h-2 w-2 rounded-full bg-cyan-500"></span>
          ...
          <ScrollReveal delay={800}>
            <div className="rounded-2xl border border-blue-500/30 bg-blue-900/20 p-6 backdrop-blur-lg transition-all duration-300 hover:bg-blue-900/30 md:col-span-2 lg:col-span-1">
              <div className="mb-4 flex items-center">
      ...
      <ScrollReveal delay={1000} className="mb-20">
        <div className="mb-12 text-center">
          <h3 className="mb-4 text-3xl font-bold text-blue-200">실무 경험</h3>
          <p className="text-lg text-gray-400">다양한 프로젝트를 통해 쌓아온 개발 역량</p>
        </div>
        <div className="space-y-12">
          {/* 우리아이시티 */}
          <ScrollReveal delay={1200}>
            <div className="rounded-3xl border border-blue-500/20 bg-blue-900/10 p-8 backdrop-blur-lg transition-all duration-500 hover:bg-blue-900/20">
              <div className="mb-6 flex items-center">
                <div className="mr-4 h-4 w-4 animate-pulse rounded-full bg-blue-400"></div>
                <div>
              ...
              <div className="mb-6 grid gap-6 md:grid-cols-2">
                <div className="rounded-2xl bg-blue-900/30 p-6">
                  <h4 className="mb-3 flex items-center text-xl font-semibold text-blue-300">
              ...
              <div className="border-l-4 border-blue-400 pl-6">
                <p className="leading-relaxed text-gray-300">
                  외근 형태의 팀 단위 파견을 통해 현장에서 직접 고객의 요구사항을 분석하고, 복잡한
                  금융 업무 프로세스를 시스템으로 구현하는 경험을 쌓았습니다.
                </p>
              </div>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={1400}>
            <div className="rounded-3xl border border-cyan-500/20 bg-cyan-900/10 p-8 backdrop-blur-lg transition-all duration-500 hover:bg-cyan-900/20">
              <div className="mb-6 flex items-center">
                <div className="mr-4 h-4 w-4 animate-pulse rounded-full bg-cyan-400"></div>
                <div>
              ...
              <div className="mb-6 grid gap-6 md:grid-cols-2">
                <div className="rounded-2xl bg-cyan-900/30 p-6">
                  <h4 className="mb-3 flex items-center text-xl font-semibold text-cyan-300">
              ...
              <div className="border-l-4 border-cyan-400 pl-6">
                <p className="leading-relaxed text-gray-300">
                  본사 내근 형태로 근무하며 개발부터 운영까지 전 과정을 경험했습니다. 특히 CI/CD
                  파이프라인 구축과 Linux 서버 관리를 통해 DevOps 역량을 키웠습니다.
                </p>
              </div>
            </div>
          </ScrollReveal>
      ...
      <ScrollReveal delay={1600} className="mb-16">
        <div className="mb-12 text-center">
          <h3 className="mb-4 text-3xl font-bold text-blue-200">추가 역량</h3>
          <p className="text-lg text-gray-400">지속적인 학습을 통해 확장해온 기술 영역</p>
        </div>
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          <ScrollReveal delay={1800}>
            <div className="rounded-2xl border border-blue-500/30 bg-gradient-to-br from-blue-900/20 to-purple-900/20 p-6 text-center backdrop-blur-lg transition-all duration-300 hover:scale-105">
              <div className="mb-3 text-3xl">🌐</div>
              <h4 className="mb-2 text-lg font-bold text-blue-300">MERN Stack</h4>
              <p className="text-sm text-gray-400">MongoDB, Express, React, Node.js</p>
            </div>
          </ScrollReveal>

          <ScrollReveal delay={2000}>
            <div className="rounded-2xl border border-purple-500/30 bg-gradient-to-br from-purple-900/20 to-pink-900/20 p-6 text-center backdrop-blur-lg transition-all duration-300 hover:scale-105">
              <div className="mb-3 text-3xl">⚡</div>
              <h4 className="mb-2 text-lg font-bold text-purple-300">Next.js & Prisma</h4>
              <p className="text-sm text-gray-400">모던 풀스택 개발</p>
            </div>
          </ScrollReveal>

          <ScrollReveal delay={2200}>
            <div className="rounded-2xl border border-green-500/30 bg-gradient-to-br from-green-900/20 to-blue-900/20 p-6 text-center backdrop-blur-lg transition-all duration-300 hover:scale-105">
              <div className="mb-3 text-3xl">🔥</div>
              <h4 className="mb-2 text-lg font-bold text-green-300">Firebase & Supabase</h4>
              <p className="text-sm text-gray-400">서버리스 백엔드 서비스</p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={2400}>
            <div className="rounded-2xl border border-purple-500/30 bg-gradient-to-br from-violet-900/20 to-purple-900/20 p-6 text-center backdrop-blur-lg transition-all duration-300 hover:scale-105">
              <div className="mb-3 text-3xl">🎨</div>
              <h4 className="mb-2 text-lg font-bold text-violet-300">UI/UX Design</h4>
              <p className="text-sm text-gray-400">Figma, 반응형 디자인</p>
            </div>
          </ScrollReveal>
        </div>
      </ScrollReveal>
