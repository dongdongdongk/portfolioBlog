        ...
        <div className="xl:divide-y xl:divide-gray-200 xl:dark:divide-gray-700">
          <header className="pt-6 xl:pb-6">
            <div className="space-y-1 text-center">
              ...
              {summary && (
                <p className="text-lg leading-7 text-gray-500 dark:text-gray-400 max-w-3xl mx-auto">
                  {summary}
                </p>
              )}
              {(liveUrl || githubUrl) && (
                <div className="flex justify-center gap-4 pt-4">
                  ...
                  {githubUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-md transition-colors"
                    >
