---
title: '10. 상속(Inherit, extends, 확장) 과 다형성'
date: '2026-09-02'
...
```java
- 부모로 부터 자식에게 상속
- 부모클래스(super class)의 멤버들을 자식클래스(child class)에서 자기 선언한 것 처럼 사용하려 하는것
- 재사용성
...
2. Interface도 다형성에 포함(부모)
	...
	public class Super()
	public interface Spuerinterface1 {}
	public interface Spuerinterface1 {}
	...
	Super super = new Child();
	super.name; (x) 부모의 메소드와 필드만 사용 가능하다.
	super.age; (o)

	Child child = (Child)super;
	Child.name; (o)
	Child.age; (o) 상속 받아서 사용가능
